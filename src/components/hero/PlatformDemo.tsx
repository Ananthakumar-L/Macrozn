  ...
  return (
    <div className="relative max-w-5xl mx-auto mb-12 md:mb-16">
      ...
      <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/20 backdrop-blur-sm">
        ...
        <div className="bg-white border-b border-gray-200 flex items-center px-3 sm:px-6 py-3 overflow-x-auto">
          ...
          <div className="flex space-x-1 overflow-x-auto scrollbar-hide flex-shrink-0">
          ...
          <div className="ml-auto hidden sm:flex items-center space-x-4 flex-shrink-0">
          ...
          <div className="ml-auto sm:hidden flex-shrink-0">
            <div className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center">
              <User className="w-4 h-4 text-gray-600" />
            </div>
          </div>
        ...
        <div className="bg-gray-50 p-3 sm:p-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6">
            ...
            <div className="lg:col-span-4 space-y-3 grid grid-cols-2 lg:grid-cols-1 gap-3 lg:gap-3">
              {/* Warmth Level */}
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
      ...
      {/* Floating UI Element - Hidden on mobile */}
      <motion.div
        initial={{ y: 20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ delay: 1.2, duration: 0.7, ease: [0.22, 1, 0.36, 1] }}
        className="absolute -left-8 top-1/3 z-10 hidden lg:block"
      >
